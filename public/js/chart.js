...
export async function fetchAuthorsData(sprintId) {
    ...
    try {
        let url = new URL(`${baseUrl}/api/v1/charts/authors/${sprintId}`);
...
export async function fetchClientsData(sprintId) {
    ...
    try {
        let url = new URL(`${baseUrl}/api/v1/charts/clients/${sprintId}`);
        let response = await fetch(url, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
...
export async function fetchStoryPointsData(sprintId) {
    ...
    try {
        let url = new URL(`${baseUrl}/api/v1/charts/points/${sprintId}`);
        let response = await fetch(url, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
...
export async function fetchAssigneeData(sprintId) {
    ...
    try {
        let url = new URL(`${baseUrl}/api/v1/charts/developers/${sprintId}`);
        let response = await fetch(url, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
...
export async function fetchPriorityData(sprintId) {
    ...
    try {
        let url = new URL(`${baseUrl}/api/v1/charts/priorities/${sprintId}`);
        let response = await fetch(url, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
...
export async function fetchStatuses(sprintId) {
    ...
    try {
        let url = new URL(`${baseUrl}/api/v1/charts/statuses/${sprintId}`);
        let response = await fetch(url, {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`
